...
# the input array that's greater than inputArray[i] . If there's no such next greater element for a
...
# itself as if it were connected end-to-end. So the next index after the last index in a circular array is the first
# index. This means that, for our problem, given array = [0, 0, 5, 0, 0, 3, 0, 0] , the next
# greater element after 3 is 5 , since the array is circular.
# Sample Input
# array = [2, 5, -3, -4, 6, 7, 2]
# Sample Output
# [5, 6, 6, 6, 7, -1, 5]
